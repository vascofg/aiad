...
public class TruckDetailsComponent extends JPanel{
    ...
    public TruckDetailsComponent(Truck truck) {
        ...
        if (!(truck.getCurrentDestination() == null))
            this.currentDestination = new JLabel("<html>(" + (int)truck.getCurrentDestination().getX() + ", " + (int)truck.getCurrentDestination().getY() + ")</html>");
        else
        ...
        switch (truck.getType()) {
            case 0:
                this.name = new JLabel("<html><font color = 'orange'>" + truck.getAgentName() + "</font> </html>");
                break;
            case 1:
                this.name = new JLabel("<html><font color = 'blue'>" + truck.getAgentName() + "</font></html>");
                break;
            case 2:
                this.name = new JLabel("<html><font color = 'green'>" + truck.getAgentName() + "</font></html>");
                break;
            case 3:
                this.name = new JLabel("<html><font color = 'black'>" + truck.getAgentName() + "</font></html>");
                break;
        }
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Font unboldFont = new Font(font.getFontName(), Font.PLAIN, font.getSize());
    ...
    public void setCurrentDestination(Truck truck) {
        this.currentDestination.setText("<html>(" + (int) truck.getCurrentDestination().getX() + ", " + (int)truck.getCurrentDestination().getY() + ")</html>");
